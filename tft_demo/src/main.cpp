...
/*
  Setup for the Wemos S3 Mini Pro board

  All these constants come from the pins_arduino.h file in the ESP32 core for the board
*/
Arduino_DataBus *bus = new Arduino_ESP32SPI(TFT_DC, TFT_CS, SCK /* SCK */, MOSI /* MOSI */, MISO /* MISO */, HSPI /* spi_num */);
Arduino_GFX *gfx = new Arduino_GC9107(bus, TFT_RST, 2 /* rotation */, true /* IPS */);
// Match the expected name for the GFX library
#define GFX_BL TFT_BL
/*
  End of Wemos S3 Mini Pro board setup
*/
